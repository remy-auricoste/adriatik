...
function randomFactoryBuilder(randomSocket, hashService) {
  if (randomSocket) {
    ...
    hashSync.syncListener(
      function(id, size, randomAsk) {
        ...
        hashSync.send(id, size, {
          hash: generated.hash,
          number: randomAsk.number
        });
      },
      function(stored) {
    ...
    valueSync.syncListener(
      function(id, size, randomValue) {},
      function(stored) {
        ...
        Object.keys(stored.values).map(function(source) {
          ...
          var calculatedHash = hashService(
            randomValue.salt + "" + randomValue.values
          );
